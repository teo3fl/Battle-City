...
GameState::GameState(sf::RenderWindow* window, std::map<std::string, int>* supportedKeys, std::stack<State*> m_states)
	: State(window, supportedKeys, m_states)
{
	InitializeKeybinds();
	InitializeTextures();
	InitializePlayer();
